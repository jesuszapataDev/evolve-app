    ...
    <div class="card">
        <div class="card-body">
            <table id="sessionAuditTable" class="table table-borderless" data-toggle="table" data-search="true"
                data-page-list="[5, 10, 20, 50, 100]" data-page-size="5" data-pagination="true" data-show-columns="true"
                data-show-pagination-switch="true" data-toolbar="#toolbar" data-locale="<?= $locale ?>">
